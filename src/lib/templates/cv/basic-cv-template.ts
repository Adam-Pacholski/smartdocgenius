  ...
  return `
    <div style="font-family: ${fontFamily}; font-size: ${fontSize}; line-height: 1.5; color: #333; max-width: 21cm; margin: 0 auto; padding: 0;">
      ...
      <div style="display: flex; padding: 0 0 30px;">
        <!-- Left Column -->
        <div style="flex: 2; padding: 20px 30px;">
          <!-- Experience Section -->
          ${data.doswiadczenie ? `
            <section>
        ...
        <!-- Right Column -->
        <div style="flex: 1; padding: 20px 30px; background-color: #f9f9f9;">
          <!-- Skills Section -->
          ${data.umiejetnosci ? `
            <section>
      ...
      <!-- Footer with Clause -->
      ${data.clause ? `
        <footer style="padding: 20px 30px; border-top: 1px solid #eee; font-size: 10px; color: #777;">
          ${data.clause}
        </footer>
      ` : ''}
    </div>
