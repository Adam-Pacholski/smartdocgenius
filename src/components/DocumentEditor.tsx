...
const DocumentEditor: React.FC<DocumentEditorProps> = ({
  ...
  const renderCVSectionForm = () => {
    switch (currentSection) {
      ...
      default:
        // Display regular fields for other sections
        return (
              ...
              if (field.type === 'textarea') {
                  ...
                  <div key={field.id} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center justify-center border rounded-md aspect-square overflow-hidden bg-gray-100">
                          {formData.photo ? (
                            <img
                              src={formData.photo}
                              alt="Podgląd zdjęcia"
                ...
                useEffect(() => {
                  if (formData[field.id]) {
                    // Try to parse formData as a date
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <CalendarComponent
                          ...
                          onSelect={(newDate) => {
                            setDate(newDate);
                            if (newDate) {
                              handleChange(field.id, format(newDate, 'dd.MM.yyyy'));
                            }
                          }}
                          initialFocus
                          className={cn("p-3 pointer-events-auto")}
