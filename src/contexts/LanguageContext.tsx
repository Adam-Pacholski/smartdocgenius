...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'privacy.cookie.content': 'This site uses cookies to provide the best user experience. By using our site, you agree to the use of cookies in accordance with our',
    ...
    'editor.section.content.desc': 'Write the content of your cover letter',
    'editor.section.clause': 'Clause',
    'editor.section.clause.desc': 'Add a personal data processing clause',
    'editor.section.config': 'Configuration',
    'editor.section.config.desc': 'Customize document appearance',
    'editor.section.experience': 'Experience',
    'editor.section.experience.desc': 'Add information about your work experience',
    'editor.section.education': 'Education',
    'editor.section.education.desc': 'Complete your education information',
    'editor.section.skills': 'Skills',
    'editor.section.skills.desc': 'List your skills',
    'editor.section.languages': 'Languages',
    'editor.section.languages.desc': 'Enter languages you know and their proficiency level',
