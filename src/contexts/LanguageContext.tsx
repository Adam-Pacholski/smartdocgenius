...
const translations: Record<Language, Record<string, string>> = {
  pl: {
    ...
    "features.templates.desc":
      "Różnorodne szablony dokumentów dostosowane do różnych branż i potrzeb.",
    "features.ease.title": "Łatwe w użyciu",
    "features.ease.desc":
      "Intuicyjny interfejs, który przeprowadzi Cię krok po kroku przez proces tworzenia dokumentu.",
    "features.custom.title": "Zaawansowana personalizacja",
    "features.custom.desc":
      "Pełna kontrola nad wyglądem i zawartością dokumentów, dostosowanych do Twoich potrzeb.",
    ...
    "contact.support.desc1":
      "APDocs jest całkowicie darmowym narzędziem, które rozwijam w ramach swojej pasji do tworzenia użytecznych aplikacji. Jeśli chcesz wesprzeć dalszy rozwój tego narzędzia, możesz to zrobić poprzez kontakt lub współpracę.",
    "contact.support.desc2":
    ...
    "privacy.cookie.content":
      " Ta strona używa plików cookie, aby zapewnić najlepsze doświadczenie użytkownika. Korzystając z naszej strony, zgadzasz się na używanie plików cookie zgodnie z naszą",
    ...
    "privacy.section3.types.necessary":
      "Niezbędne pliki cookie - konieczne do prawidłowego funkcjonowania serwisu",
    "privacy.section3.types.functional":
      "Funkcjonalne pliki cookie - umożliwiające zapamiętywanie preferowanych ustawień użytkownika",
    "privacy.section3.types.analytical":
      "Analityczne pliki cookie - służące do analizy sposobu korzystania z serwisu",
    ...
    "editor.section.clause.desc":
      "Dodaj klauzulę o przetwarzaniu danych osobowych",
    ...
    "editor.section.experience.desc":
    ...
    "editor.section.languages.desc":
      "Podaj znane Ci języki obce i poziom ich znajomości",
    "editor.section.portfolio": "Portfolio",
    ...
    "editor.reset.confirmDescription":
      "Wszystkie wprowadzone dane zostaną usunięte i nie będzie można ich odzyskać.",
  ...
  en: {
    ...
    "app.description":
      "APDocs is a modern app that helps you create professional documents in just minutes.",
    ...
    "features.subtitle":
      "A tool designed to simplify and speed up the creation of professional documents.",
    "features.templates.title": "Professional templates",
    "features.templates.desc":
      "Various document templates tailored to different industries and needs.",
    "features.ease.title": "Easy to use",
    "features.ease.desc":
      "An intuitive interface that guides you step-by-step through the document creation process.",
    "features.custom.title": "Advanced customization",
    "features.custom.desc":
      "Full control over the look and content of your documents, tailored to your needs.",
    "cta.title": "Ready to create professional documents?",
    "cta.subtitle":
      "Join thousands of satisfied users and start creating professional documents today.",
    ...
    "contact.support.desc1":
      "APDocs is a completely free tool that I develop out of passion for creating useful applications. If you want to support its further development, you can do so through contact or collaboration.",
    "contact.support.desc2":
      "Your support helps keep the application free and available to everyone.",
    "privacy.cookie.title": "Cookie Policy",
    "privacy.cookie.content":
      "This site uses cookies to ensure the best user experience. By using our site, you agree to the use of cookies in accordance with our",
    "privacy.title": "Privacy and Cookie Policy",
    "privacy.section1.title": "1. General information",
    "privacy.section1.content":
      "This Privacy and Cookie Policy defines the principles for processing and protecting personal data and the use of cookies within the APDocs service.",
    ...
    "privacy.section3.content":
      "The service uses cookies to personalize content and analyze site traffic.",
    "privacy.section3.what.title": "What are cookies?",
    "privacy.section3.what.content":
      "Cookies are small text files stored on the user's device while browsing websites. They are used to remember user preferences and facilitate website use.",
    "privacy.section3.types.title": "Types of cookies used:",
    "privacy.section3.types.necessary":
      "Necessary cookies – essential for the proper functioning of the site",
    "privacy.section3.types.functional":
      "Functional cookies – enable remembering user preferences",
    "privacy.section3.types.analytical":
      "Analytical cookies – used to analyze how the service is used",
    "privacy.section4.title": "4. Managing cookies",
    "privacy.section4.content1":
      "Users can manage cookies themselves by changing their web browser settings. Limiting cookie use may affect the functionality of the site.",
    "privacy.section4.content2":
      "Not changing browser settings means acceptance of the used cookies.",
    "privacy.section5.title": "5. Contact",
    "privacy.section5.content":
      "If you have any questions regarding the Privacy and Cookie Policy, please contact us at: info@ap-development.eu",
    "cookie.message":
    ...
    "editor.section.languages.desc":
      "Specify languages you know and proficiency levels",
    ...
    "editor.reset.confirmDescription":
      "All entered data will be deleted and cannot be recovered.",
  ...
  de: {
    ...
    "app.description":
      "APDocs ist eine moderne Anwendung, die Ihnen hilft, professionelle Dokumente in Minuten zu erstellen.",
    ...
    "features.subtitle":
      "Ein Tool, das den Prozess der Erstellung professioneller Dokumente vereinfacht und beschleunigt.",
    "features.templates.title": "Professionelle Vorlagen",
    "features.templates.desc":
      "Verschiedene Dokumentvorlagen, die auf unterschiedliche Branchen und Bedürfnisse zugeschnitten sind.",
    "features.ease.title": "Einfach zu bedienen",
    "features.ease.desc":
      "Eine intuitive Benutzeroberfläche, die Sie Schritt für Schritt durch den Prozess der Dokumentenerstellung führt.",
    "features.custom.title": "Erweiterte Anpassung",
    "features.custom.desc":
      "Volle Kontrolle über das Aussehen und den Inhalt von Dokumenten, angepasst an Ihre Bedürfnisse.",

    // CTA section
    "cta.title": "Bereit, professionelle Dokumente zu erstellen?",
    "cta.subtitle":
      "Schließen Sie sich Tausenden zufriedener Benutzer an und beginnen Sie noch heute mit der Erstellung professioneller Dokumente.",
    ...
    "contact.form.success.desc":
      "Vielen Dank für Ihre Kontaktaufnahme. Wir werden so schnell wie möglich antworten.",
    ...
    "contact.support.desc1":
      "APDocs ist ein völlig kostenloses Tool, das ich im Rahmen meiner Leidenschaft für die Erstellung nützlicher Anwendungen entwickle. Wenn Sie die Weiterentwicklung dieses Tools unterstützen möchten, können Sie dies durch Kontakt oder Zusammenarbeit tun.",
    "contact.support.desc2":
      "Ihre Unterstützung hilft mir, die Anwendung kostenlos und für alle verfügbar zu halten.",

    // Privacy policy page
    "privacy.cookie.title": "Cookie-Richtlinie",
    "privacy.cookie.content":
      "Diese Website verwendet Cookies, um die bestmögliche Benutzererfahrung zu gewährleisten. Durch die Nutzung unserer Website stimmen Sie der Verwendung von Cookies gemäß unserer",
    "privacy.title": "Datenschutz- und Cookie-Richtlinie",
    "privacy.section1.title": "1. Allgemeine Informationen",
    "privacy.section1.content":
      "Diese Datenschutz- und Cookie-Richtlinie definiert die Regeln für die Verarbeitung und den Schutz personenbezogener Daten sowie die Verwendung von Cookies im Rahmen des APDocs-Dienstes.",
    "privacy.section2.title": "2. Datenverwalter",
    "privacy.section2.content":
      "Der Verwalter personenbezogener Daten ist AP-Development.eu.",
    "privacy.section3.title": "3. Cookies",
    "privacy.section3.content":
      "Der Dienst verwendet Cookies, um Inhalte zu personalisieren und den Website-Verkehr zu analysieren.",
    "privacy.section3.what.title": "Was sind Cookies?",
    "privacy.section3.what.content":
      "Cookies sind kleine Textdateien, die beim Surfen auf Websites auf dem Gerät des Benutzers gespeichert werden. Sie dienen dazu, die Benutzereinstellungen zu speichern und die Nutzung der Website zu erleichtern.",
    "privacy.section3.types.title": "Arten von verwendeten Cookies:",
    "privacy.section3.types.necessary":
      "Notwendige Cookies - erforderlich für das ordnungsgemäße Funktionieren des Dienstes",
    "privacy.section3.types.functional":
      "Funktionale Cookies - ermöglichen das Speichern der bevorzugten Einstellungen des Benutzers",
    "privacy.section3.types.analytical":
      "Analytische Cookies - dienen zur Analyse der Nutzung des Dienstes",
    "privacy.section4.title": "4. Cookie-Verwaltung",
    "privacy.section4.content1":
      "Der Benutzer kann Cookies selbst verwalten, indem er die Einstellungen seines Webbrowsers ändert. Die Einschränkung der Verwendung von Cookies kann die Funktionalität des Dienstes beeinträchtigen.",
    "privacy.section4.content2":
      "Wenn die Browser-Einstellungen nicht geändert werden, bedeutet dies, dass die verwendeten Cookies akzeptiert werden.",
    "privacy.section5.title": "5. Kontakt",
    "privacy.section5.content":
      "Bei Fragen zur Datenschutz- und Cookie-Richtlinie kontaktieren Sie uns bitte unter: info@ap-development.eu",

    // Cookie consent
    "cookie.message":
      "Wir verwenden Cookies, um das beste Erlebnis auf unserer Website zu gewährleisten.",
    ...
    "editor.subtitle":
      "Erstellen Sie ein professionelles Dokument in wenigen einfachen Schritten",
    "editor.defaultDocName": "Dokument",
    ...
    "editor.export.success":
      "Das Dokument wurde generiert und heruntergeladen.",
    ...
    "editor.section.content.desc":
      "Schreiben Sie den Inhalt Ihres Anschreibens",
    ...
    "editor.section.config.desc":
      "Passen Sie das Erscheinungsbild des Dokuments an",
    "editor.section.experience": "Erfahrung",
    "editor.section.experience.desc":
      "Fügen Sie Informationen zu Ihrer Berufserfahrung hinzu",
    "editor.section.education": "Bildung",
    "editor.section.education.desc":
      "Vervollständigen Sie Ihre Bildungsinformationen",
    ...
    "editor.section.languages.desc":
      "Geben Sie Sprachen an, die Sie kennen, und deren Kenntnisstand",
    "editor.section.interests": "Interessen",
    "editor.section.portfolio": "Portfolio",
    "editor.section.interests.desc":
      "Beschreiben Sie Ihre Interessen und Hobbys",
    "editor.reset.confirmTitle":
      "Möchten Sie das Dokument wirklich zurücksetzen?",
    "editor.reset.confirmDescription":
      "Alle eingegebenen Daten werden gelöscht und können nicht wiederhergestellt werden.",
